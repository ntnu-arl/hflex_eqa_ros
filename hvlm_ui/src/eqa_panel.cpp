...
constexpr auto kTriggerStepService = "/hvlm_planner/search_manager/trigger_step";
constexpr auto kTriggerStopService = "/hvlm_planner/search_manager/trigger_stop";
constexpr auto kTriggerNextObjectService =
    "/hvlm_planner/search_manager/trigger_next_object";
...
PLUGINLIB_EXPORT_CLASS(hvlm_ui::EQAPanel, rviz_common::Panel)
